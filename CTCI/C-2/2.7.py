...
"""
 Prompt 2.7 : Python - Intersection
                        Given two (singly) linked lists, determine if the two lists intersect. 
                        return the intersecting node. note that the intersection is defined based 
                        on references, no value. that is, if the kth node of the first linked 
                        list is the exact same node (by references) as the jth node of the 
